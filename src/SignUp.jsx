...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const validatedPassword = testPassword(password);
    ...
    try {
      ...
      setGoodMessage(
        "User signed up successfully. Verification email sent. Kindly verify your email."
      );
      setMessage("");
      setTimeout(() => {
        navigate("/vault");
      ...
      if (error.code === "auth/email-already-in-use") {
        setMessage(
          `Sign-up error: Email already exists. Kindly sign in or enter another email.`
        );
      } else {
            ...
            <div>
             ...
             `}
              ...
              ${password.length == 0 ? "pt-2" : "py-2"} ${
                ...
                <a href="/" className="mt-8 absolute">Sign In</a>
